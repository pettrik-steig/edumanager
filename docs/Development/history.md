...
## 2026-05-28 - D2 Considered A Constructive Failure For Concept Work

D2 was tried for early architecture and workflow concept diagrams.

The experiment showed that D2 works technically, but its automatic layout is a
poor fit when spatial placement carries conceptual meaning. It is better suited
for small stable diagrams or for presenting already-understood results than for
open concept exploration.

The D2 executable and reference material were moved under `Tools/D2`. The
experiment files from `docs/Development` were archived there and removed from
the active development documentation.

The experiment also clarified a process point: focusing on one concrete
application aspect fits the intended agile approach better than starting with a
top-down model of the whole system. This bottom-up perspective leads to
different architectural questions, especially around real information flow,
actors, data stores, and transfer media.
